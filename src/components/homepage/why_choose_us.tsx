  ...
  return (
    <section className="py-28">
      <HeaderSection
        ...
        subtitle="Here are some reasons why our app is the best choice for navigating Seoul."
      />
      <div className="relative z-8 grid grid-cols-6 gap-3 px-6 sm:px-0 mt-12 ">
        {/* First card */}
        ...
        <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
          <div>
                ...
                <defs>
                  ...
                  <clipPath id="clip0_0_1">
                    <rect
                      ...
                      height="72"
                      fill="white"
                      className="fill-primary opacity-100"
            ...
            <div className="relative z-8 mt-8 space-y-1.5 text-center">
              <h2 className="text-lg font-medium text-foreground">
                Secure and Reliable
              </h2>
              <p className="text-muted-foreground">
                We take security seriously. Our platform is built with the
                latest security practices to ensure your data is safe.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
          <div>
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <stop
                      className="text-background dark:text-transparent"
                      offset="1"
                      stopColor="currentColor"
            ...
            <div className="relative z-8 mt-8 space-y-1.5 text-center">
              ...
              <p className="text-muted-foreground">
                Provides live information on city events, job openings, and
                tourism updates.
              </p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2">
            <div className="relative z-8 flex flex-col justify-between space-y-12 lg:space-y-6">
              <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:bg-white/5 dark:before:border-white/5 dark:before:bg-white/5">
                <Image
                  src="/multi-platform-svgrepo-com.svg"
                  width={20}
                  height={20}
                  className="m-auto"
                  alt={""}
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Cross-platform compatibility ensures the app works on any
                  device.
                </p>
              </div>
            </div>
          ...
          <div className="grid h-full sm:grid-cols-2">
            <div className="relative z-8 flex flex-col justify-between space-y-12 lg:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Combines multiple services in one app, eliminating the need
                  for multiple platforms.
                </p>
              </div>
            </div>
            <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-primary sm:-my-8 sm:-mr-8">
              <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                  <span className="block h-fit rounded-md border bg-muted/50 px-2 py-1 text-xs">
                    Check out Seoul Tower
                  </span>
