...
export default function page({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { mutate: updateBusinessItem } = useMutation({
  ...
  useEffect(() => {
    if (business) {
      console.log("Original business data:", business); // Debug log

      const formattedBusiness = {
        ...business,
        opportunities: {
          mentorshipPrograms: Array.isArray(business.opportunities?.mentorshipPrograms) 
            ? business.opportunities.mentorshipPrograms 
            : [],
          networkingEvents: Array.isArray(business.opportunities?.networkingEvents) 
            ? business.opportunities.networkingEvents 
            : [],
          partnerships: Array.isArray(business.opportunities?.partnerships) 
            ? business.opportunities.partnerships 
            : [],
          funding: Array.isArray(business.opportunities?.funding) 
            ? business.opportunities.funding.map(fund => ({
                ...fund,
        ...
        openingHours: {
          weekday: business.openingHours?.weekday || "",
          weekend: business.openingHours?.weekend || "",
          holidays: business.openingHours?.holidays || "",
        },
        news: Array.isArray(business.news) ? business.news : [],
        contact: {
          ...business.contact,
      ...
      console.log("Formatted business data:", formattedBusiness); // Debug log
      form.reset(formattedBusiness);
    }
  }, [business, form]);
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      const updatedBusiness: BusinessType = {
        id: business!.id,
        ...values,
        opportunities: {
          mentorshipPrograms: values.opportunities?.mentorshipPrograms || [],
          networkingEvents: values.opportunities?.networkingEvents || [],
          partnerships: values.opportunities?.partnerships || [],
      ...
      console.log("Formatted business data:", updatedBusiness); // Debug log
      await updateBusinessItem(updatedBusiness);
